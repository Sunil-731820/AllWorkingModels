...
public class RestorePasswordId {
	private int id ;
	...
	public String toString() {
		return "RestorePasswordId [id=" + id + ", nickName=" + nickName + ", schoolName=" + schoolName + ", petName="
				+ petName + ", favSports=" + favSports + ", favIdeal=" + favIdeal + "]";
	}
