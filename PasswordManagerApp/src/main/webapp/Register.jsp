...
<%@page import="com.java.jsp.Register"%>
                ...
                <div class="container"> 
                    <div class="signup-content"> 
                        <div class="signup-form">
                            ...
                            <form method="POST" class="register-form" id="register-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="userName" id="email" placeholder="Your UserName" required="required" min="5"/>
                                </div>
                              
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h4></h4>
                                <div class="form-group">
                                    <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                    <input type="number" name="pinCode" id="pass" placeholder="Your PassCode" required="required"/>
                                </div>
                        ...
                        <div class="signup-image">
                            ...
                            <h2><a href="Login.jsp" class="signup-image-link">Log In</a></h2>
                        </div>
                    </div>
                </div>
            </section>
